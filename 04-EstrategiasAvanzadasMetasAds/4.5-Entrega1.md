# Entrega N°1: Tácticas publicitarias
- **Objetivos generales**
...
- **Táctica/s**
    - El objetivo publicitario tiene estrecha relación con lo establecido en la estrategia. Es claro que se desprende de ella y, sobre todo, del objetivo comercial. Es posible comprender de qué manera se intenta responder a la necesidad de la marca, emprendimiento, negocio o idea. 
...
| **Características**             | **Emma Thompson**           | **Bruno Gonnet**             | **Camila Perdomo**                       |
|----------------------------------|--------------------------------------|--------------------------------------|--------------------------------------|
| **Edad, empleo y género**            | 38 años, médica, mujer               | 45 años, emprendedor, hombre         | 21 años, estudiante de Educación Física, mujer |
| **Estudios**                         | Universitarios completos             | Universitarios incompletos           | Cursando nivel terciario             |
| **Nivel de ingresos**                | Medio-alto                           | Alto                                  | Medio-bajo                           |
| **Lugar de residencia**              | Colonia del Sacramento               | Colonia Valdense                     | Nueva Helvecia                       |
| **Redes sociales que usa**           | Instagram, Facebook                  | Facebook, Strava                     | Instagram, TikTok                    |
| F**recuencia de uso**                | Diaria                               | Varias veces por semana              | Varias veces al día                  |
| **Influencers y marcas que sigue**   | @corredoras, @vidasana              | @kilianjornet, marcas outdoor        | Influencers de running en TikTok     |
| Pasatiempos                      | Running, yoga, leer                  | Trail running, bici de montaña       | Salir con amigos, trotar, gym        |
| **Pasiones**                         | Bienestar integral, naturaleza       | Superación, aventura, comunidad      | Salud, deporte, descubrir cosas nuevas |
| **Contenidos que consume**           | Podcasts de salud, blogs de running | Videos de carreras, entrevistas      | Reels motivacionales, playlists      |
|**Qué espera de una marca**          | Cercanía, propósito, estética        | Profesionalismo, innovación, pasión | Que sea divertida, auténtica, motivadora |
|**Qué espera de Colonia Aventura Corre** | Eventos bien organizados, comunidad activa | Desafíos, experiencias únicas        | Sentirse bienvenida, formar parte del grupo |


## 3. 📣 Táctica Publicitaria

**Objetivo Comercial:**
Dar a conocer y posicionar a *Colonia Aventura Corre* como un espacio de pertenencia, entrenamiento y comunidad para corredores, ciclistas y aventureros en la región de Colonia.

**Objetivo Publicitario:**
Generar reconocimiento de marca y aumentar la comunidad online de *Colonia Aventura Corre* en redes sociales, especialmente Instagram y Facebook, para atraer nuevos interesados en participar en sus actividades y eventos.

**Tipo de Campaña:**
Campaña de **Reconocimiento de marca** + **Interacción** (Me gusta, comentarios, reproducciones de video, seguidores).

### 🔁 Etapa del Funnel

La marca se encuentra en la **etapa de descubrimiento** (top of funnel). El objetivo es que personas que aún no conocen el proyecto lo descubran, lo sigan y empiecen a relacionarse con él.

### 👥 Público Objetivo

**Segmentación general inicial:**

- **Rango de edad:** 18 a 50 años  
- **Sexo:** Todos  
- **Idioma:** Español  
- **Ubicación geográfica:**  
  - Prioridad: Colonia del Sacramento, Colonia Valdense, Rosario, Nueva Helvecia  
  - Secundario: Resto del departamento de Colonia y zonas vecinas (San José, Soriano)

**Intereses:**
- Running, ciclismo, trail, triatlón, deportes al aire libre
- Vida saludable, entrenamiento físico, yoga, bienestar
- Eventos deportivos, maratones, Ironman, Spartan Race

**Plataformas:**  
- Instagram (principal canal visual y juvenil)  
- Facebook (para conectar con audiencias más adultas y locales)

### 💰 Presupuesto y Período

- **Presupuesto inicial:** $10.000 UYU  
  - Posibilidad de ampliación a $20.000 UYU si se desea escalar la campaña o incluir Google Ads como complemento.

- **Duración estimada de campaña:**  
  - **Primera fase:** 2 semanas de reconocimiento e interacción  
  - **Segunda fase (opcional):** 2 semanas con objetivo de conversión (registro a eventos o comunidad)

### 📌 Observaciones:

- La táctica puede adaptarse en función de la recepción inicial y las métricas obtenidas (CTR, CPC, engagement).
- Es recomendable utilizar creatividades visuales auténticas del equipo (fotos/videos reales) para generar mayor conexión y credibilidad.
