...
## Microdesafío
G.A. ¿Verdadero o Falso?

|         Pregunta                 | Verdadero          | Falso                | 
| ----------------------- | ---------------------|  ---------------------|  
| Google Analytics analiza comportamientos de los usuarios en un sitio web? | ✔️ | |
| Puedo utilizar Google Analytics para medir el comportamiento de mi buyer persona sin tener sitio web | | ❌ | 
| Los datos de las herramientas de web alanytics son 100% precisos  | | ❌ | 
| Los filtros son condiciones que se aplican a las propiedades de analytivs para excluir o transformar los datos que se recogen de ellas | ✔️ | |
| Las audiencias en GA4 están determinadas por eventos | ✔️ | |

## Tipos de audiencias
- **Las audiencias en GA4 están determinadas por eventos**: dependiendo las condiciones será el tipo de audiencia que generes. 
- **Las combinaciones de eventos que elijas con inifinitas**: puedes personalizar las audiencias tanto como quieras incluyendo las condiciones de comportamientos que prefieras y se adapten mejor a tu negocio. 
- **Los eventos pueden ser considerados conversiones, acciones de valor**: puedes generar audiencias que sean específicamente de usuarios que realizaron alguna acción de valor para tu negocio en tu sitio. 
- **Audiencias por default**: GA4 viene con audiencias configuradas por defaul, como "todos los usuarios" y "compradores", está última para recopilar todos los que hayan realizado al menos una transacción.